...
description: >
  Use when authoring or revising any document an agent reads - a SKILL.md,
  an agent definition, AGENTS.md or CLAUDE.md, or a reference doc reached by
  a pointer - and you are deciding what to inline, what to push behind a
  pointer, how to word a description, or what to cut.
---

# Writing for Agents

Adapted from [mattpocock/skills](https://github.com/mattpocock/skills/blob/main/skills/productivity/writing-for-agents/SKILL.md).

This skill covers what a document should *contain*. For the process of building and testing a skill (baseline scenarios, RED-GREEN-REFACTOR, pressure testing), use **writing-skills**. For the canonical `agents/*.md` shape, use **writing-agents**.
